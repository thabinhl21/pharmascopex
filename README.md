...
Before starting, please ensure that you have Python 3.10-3.11 installed. If not, please follow the instructions here to get it installed: https://www.python.org/downloads/ </br>
Python 3.12+ is not yet supported due to package compatibility.
